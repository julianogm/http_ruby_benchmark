...
### HTTP RubyGems Benchmark - 2026-08-29
...
|-----|-----------|------------|----------|
| Net::HTTP | 1143 | 623 | 0.0528 |
| Faraday | 1099 | 629 | 0.0539 |
| HTTParty | 1093 | 579 | 0.0539 |
| Typhoeus | 82 | 552 | 0.0579 |
| httpx | 634 | 955 | 0.0577 |
| http.rb | 1159 | 1529 | 0.091 |

**Normal (100 KB)** (100 KB, 30 requests)

| Gem | Memory (KB) | Allocations | Time (s) |
|-----|-----------|------------|----------|
| Net::HTTP | 1391 | 620 | 0.0724 |
| Faraday | 1321 | 629 | 0.0783 |
| HTTParty | 1315 | 585 | 0.0746 |
| Typhoeus | 214 | 571 | 0.0741 |
| httpx | 421 | 1061 | 0.0839 |
| http.rb | 1190 | 2013 | 0.1051 |

**Heavy (1 MB)** (1024 KB, 10 requests)

| Gem | Memory (KB) | Allocations | Time (s) |
|-----|-----------|------------|----------|
| Net::HTTP | 4394 | 689 | 0.0393 |
| Faraday | 4190 | 702 | 0.0389 |
| HTTParty | 4182 | 645 | 0.0384 |
| Typhoeus | 1489 | 754 | 0.0392 |
| httpx | 2212 | 1728 | 0.0647 |
| http.rb | 1349 | 4462 | 0.0698 |
